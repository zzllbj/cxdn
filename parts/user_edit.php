...
.mesWindowTop { width:503px; height:24px; line-height:20px; padding:6px 10px 0 17px; font-weight:bold; background:-webkit-gradient(linear, 0 100%, 0 0, from(#7A0707), to(#FC0606)); background:-moz-linear-gradient(top, #ffffff, #E6E4E0); filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffff', endColorstr='#E6E4E0');
-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffff', endColorstr='#E6E4E0')"; }
...
<div class="admin_index">
  ...
  <div class="admin_menu bg_color">
    <ul>
      ...
      <li class="hover"><a href="<?php echo sys_href($params['id'],'user_edit')?>">基本资料</a></li>
