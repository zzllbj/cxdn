...
if(!empty($tag['data.results']))
{
	foreach ($tag['data.results'] as $k=>$data)
	{
		...
		{
		?>
		<li><?php echo $data['prefix']; ?><a  href="<?php echo sys_href($params['id'],'rss',$data['id'],$params['i'])?>" title="<?php echo $data['summary']?$data['summary']:$data['title']; ?>"  target="_blank" class="jt"><?php echo $data['title']; ?></a></li>
		<?php	
		}
		else
		{
		?>
		<li><?php echo $data['prefix']; ?><a href="<?php echo sys_href($params['id'],'rss',$data['id'],$params['i'])?>" title="<?php echo $data['summary']?$data['summary']:$data['title']; ?>" class="yl" target="_blank"><?php echo $data['title']; ?></a></li>
		<?php
		}
	}
}
