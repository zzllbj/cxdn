...
<div class="admin_index">
  ...
  <div class="admin_menu">
    <ul>
      ...
      <li class="hover"><a href="<?php echo sys_href($params['id'],'user_comment')?>">评论管理</a></li>
...
if( !empty( $tag['data.results'] ) )
{
	...
	?>
    <div class="am_mess">
      <h3><span><?php echo $data['dtTime']; ?></span>[<?php echo $data['from']; ?>]&nbsp;&nbsp;<a href="<?php echo $data['url']; ?>" target="_blank"><?php echo $data['title']; ?></a></h3>
      <p><span>我的评论：</span><?php echo $data['content']; ?></p>
    </div>
    <?php
	}
}
